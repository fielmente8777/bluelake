  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute inset-0 flex items-start px-5 pt-[40px] sm:px-8 sm:pt-[40px] lg:px-[7.5%] lg:pt-[40px]">
          ...
          >
            ...
            <p className="m-0 font-display text-base tracking-[0.06em]">
              ANTE MERIDIEM
            </p>
      ...
      >
        <div className="mx-auto grid max-w-[1280px] gap-[30px] md:grid-cols-[1.15fr_1fr_1fr]">
          <div>
            <p className="m-0 flex items-center gap-2 text-[10px] font-bold tracking-[0.12em] text-text-on-dark uppercase before:block before:h-px before:w-5 before:bg-gold">
              Let&rsquo;s Connect
            </p>
            <h2 className="mt-3.5 max-w-[14ch] font-display text-[clamp(27px,3vw,32px)] leading-[1.08] font-medium text-white">
              Plan Your Escape to Serenity
            </h2>
            <p className="mt-3 max-w-[30ch] text-[11px] leading-[1.55] text-text-on-dark-muted">
          ...
          <div className="md:border-l md:border-white/15 md:pl-[30px]">
            <h3 className="mb-3 font-body text-[10px] font-bold tracking-[0.1em] text-white uppercase">
              Location
            </h3>
            <div className="mb-3 flex gap-3 [&>svg]:mt-px [&>svg]:h-5 [&>svg]:w-5 [&>svg]:shrink-0 [&>svg]:text-white">
              <PinIcon aria-hidden="true" />
              <p className="m-0 text-[11px] leading-[1.45] text-text-on-dark">
          ...
          <div className="md:border-l md:border-white/15 md:pl-[30px]">
            ...
            <div className="mb-3.5 mt-2 flex gap-2.5">
              <a
                href="#"
            ...
            <p className="mb-3 text-xs text-inherit">
        ...
        <div className="mx-auto mt-7 flex min-h-[38px] max-w-[1280px] flex-col items-start gap-3 border-t border-white/22 pt-3 pb-3.5 text-[10px] text-text-on-dark-muted sm:flex-row sm:items-center sm:justify-between sm:pb-0">
